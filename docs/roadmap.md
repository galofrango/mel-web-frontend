...
- **Separadores verticales estandarizados en todo el sitio** (D-043/D-045): mínimo 32px a cada lado de cualquier separador entre módulos `TagWithLink`, siempre como elemento independiente (no incrustado en el propio tag) — Highlights de la home, panel del mapa. Reparto regular a lo ancho completo cuando el contenido cabe, en vez de agruparse a la izquierda. Sin separador fantasma antes del primer tag.
