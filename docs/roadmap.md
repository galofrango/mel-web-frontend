...
- **Botón flotante para cambiar el orden** (apunte del propietario, 2026-07-28, *a la espera de feedback de la gente*). Textualmente:
  ...
  - Se descartó de momento invertir el valor por defecto (cronológico por defecto, barajar como botón) para no perder el carácter del mosaico, que el propietario valora explícitamente.
