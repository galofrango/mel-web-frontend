...
- **Toolbar de la home (Highlights + Toggle) con `flex-wrap` real** (D-048): el Toggle comparte fila con las tags cuando cabe (creciendo para ocupar el resto del ancho) y salta a su propia fila a ancho completo en cuanto su suelo de 320px no cabe junto al ancho natural de las tags — sin depender de ningún breakpoint fijo. Gap de 24px entre tags y divisores (Figma 341:26425).
